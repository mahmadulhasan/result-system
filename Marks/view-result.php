...
$name = $dob = $school_name = $school_add = $school_pin = "";
$class = $section = $session = $exam_name = $result_table_name = $subject_table_name = "";

// Assign values from POST request if they are set
if (isset($_POST['roll'])) {
    $roll = $_POST['roll'];
}
if (isset($_POST['dob'])) {
...
if (isset($_POST['result_table_name'])) {
    $result_table_name = $_POST['result_table_name'];
}
if (isset($_POST['subject_table_name'])) {
...
$query1 = "SELECT `student_id` FROM `10_2024-2025_4_A_UNIT 1_result` WHERE `Roll_no` = '$roll'";
...
<section id="print-section" class="mt-5 p-5 container">
    ...
    <div class="border border-dark">
        ...
        <div class=" text-center border border-dark py-2">
            ...
            <h6>
                <?php echo $school_add.' - '.$school_pin ?>
            </h6>
            <h4>
        ...
        <!----------Name section---------------->
        <div class="p-3 border border-dark  background-color:none !important;">
            ...
            <?php
                ...
                ?>
            <table class="table" style="border: none !important;  background-color:none !important;">
                <table style="width: 100%; border-collapse: collapse;  background-color:none !important;">
                    <tbody>
                        ...
                        <tr class=" ">
                            ...
                            <td style="border: none; text-align: left; vertical-align: top;">
                                <table style="width: 100%; border-collapse: collapse;  background-color:none !important;" class="p-3 table">
                                    <tr class="pb-3">
