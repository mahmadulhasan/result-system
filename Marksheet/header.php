        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-primary justify-content-between pe-5 ps-5">
            ...
            <div class="collapse navbar-collapse ms-auto end-0 justify-content-between" id="navbarNav">
                <ul class="navbar-nav pe-5">
                    ...
                    <li class="nav-item pe-3">
                        <a class="nav-link a" aria-current="page" href="../about-us.php">About</a>
                    </li>
                    <li class="nav-item pe-3">
                        <a class="nav-link a" aria-current="page" href="../contact-us.php">Contact</a>
                    </li>
                    <li class="nav-item dropdown pe-3">
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="index.php">Old result</a></li>
                      </ul>
                    </li>
                </ul>
